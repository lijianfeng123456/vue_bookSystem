  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.bi_name" placeholder="输入图书名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    >
     ...
     <el-table-column  prop="bi_id" label="图书编号" v-if="false"></el-table-column>
	  ...
	  <el-table-column prop="bt_id" label="图书类别"  :formatter="changeBookType"></el-table-column>
   ...
   <el-popover
    ...
    title=""
    trigger="hover">
    <img :src="scope.row.bi_img" style="max-height: 400px;max-width: 550px" />
    <img slot="reference" :src="scope.row.bi_img" :alt="scope.row.picture" style="max-height: 50px;max-width: 130px">
   </el-popover>
  </template>
	  </el-table-column>
      ...
      <el-table-column label="操作" >
        <template scope="scope">
          ...
          <el-button type="danger" size="small" @click="handleDel(scope.$index, scope.row)" style="margin-top:10px">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
	  changeBookType:function(row,column){
